...
namespace BMCSDL.DAL
{
    class DALLuuTru
    {
        ...
        public DataTable ExecuteGetDataIntoDGV()
        {
            ...
            OracleDataAdapter adapter = new OracleDataAdapter("select id, TTXETDUYET from TIN.PASSPORTDATA where TTXETDUYET!='Chưa duyệt' and TTTHONGBAO!='Đã thông báo'", mydb.getConnectionNV());
            adapter.Fill(table);           
